            ...
            <motion.div variants={heroWrap} initial="hidden" animate="visible" className="flex flex-col items-center">
              ...
              <motion.p variants={heroItem} className="mx-auto mb-12 max-w-4xl text-base font-normal leading-8 text-[#121212]/58 md:text-xl md:leading-9">
                <span className="block">
                  ForgeStack Labs engineers custom software, operational platforms, SaaS products, and AI-enabled business systems for companies in India and international markets.
                </span>
                <span className="mt-3 block">
                  Our flagship product, Fuel OS, is an offline-first operating system purpose-built for fuel retailers, while our engineering team partners remotely with organizations to design secure, scalable software tailored to complex real-world operations.
                </span>
              </motion.p>
            ...
            >
              ...
              >
                ...
                <motion.p variants={fadeUp} className="mt-8 text-sm text-white/25">
                  hello@forgestacklabs.com · Engineered in Mangaluru, delivering globally.
                </motion.p>
              </motion.div>
