...
export const metadata: Metadata = {
  title: "Industries",
  description: "Operational software for fuel retail, logistics, manufacturing, enterprise SaaS, custom platforms, and AI automation.",
  alternates: { canonical: "/industries" },
  openGraph: {
    title: "Industries | Forgestack Labs",
    description: "Operational software for fuel retail, logistics, manufacturing, enterprise SaaS, custom platforms, and AI automation.",
    url: "/industries",
    type: "website",
  },
